...
def create_pdf_export(history_data):
    ...
    try:
        ...
        # Prepare table data
        table_data = [['Student Name', 'Attendance', 'Assignment', 'Internal', 'Predicted', 'Performance']]
        ...
        # Create table
        table = Table(table_data, colWidths=[1.4*inch, 0.9*inch, 0.9*inch, 0.9*inch, 0.9*inch, 1.4*inch])
